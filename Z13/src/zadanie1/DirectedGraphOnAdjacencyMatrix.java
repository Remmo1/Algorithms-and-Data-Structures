...
public class DirectedGraphOnAdjacencyMatrix<T> implements Graph<T> {
    ...
    public DirectedGraphOnAdjacencyMatrix(ArrayList<Node<T>> vertices, ArrayList<Edge<T>> edges) {
