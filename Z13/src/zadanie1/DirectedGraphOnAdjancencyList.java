...
public class DirectedGraphOnAdjancencyList<T> implements Graph<T> {
    ...
    public DirectedGraphOnAdjancencyList() {
    ...
    public ArrayList<ArrayList<Node<T>>> getList() { return list; }
